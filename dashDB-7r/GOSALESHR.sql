...
select a13.EMPLOYEE_CODE, MTG_DTE, MTG_NM_CAT, MTG_LOC, sum(MTG_DUR) MTG_DUR_TTL, sum(MTG_INVTD_CT) MTG_INVTD_TTL. sum(MTG_ACCPTD_CT) MTG_ACCPTD_TTL, sum(MTG_DCLND_CT) MTG_DCLND_TTL
from(
